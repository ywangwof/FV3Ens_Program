...
rain_three_90, rain_three_max, rain_three_3km, rain_three_27km, rain_three_42km = calc_ens_products(rain, 1, radius_max_27km, radius_max_42km, kernel, rain_4_thresh)

rain_six_90, rain_six_max, rain_six_3km, rain_six_27km, rain_six_42km = calc_ens_products(rain, 1, radius_max_27km, radius_max_42km, kernel, rain_5_thresh)
...
ws_80_ts_90, ws_80_ts_max, ws_80_ts_9km, ws_80_ts_27km, ws_80_ts_42km = calc_ens_products(ws_80, radius_max_9km, radius_max_27km, radius_max_42km, kernel, ws_80_thresh_ts)

ws_80_h1_90, ws_80_h1_max, ws_80_h1_9km, ws_80_h1_27km, ws_80_h1_42km = calc_ens_products(ws_80, radius_max_9km, radius_max_27km, radius_max_42km, kernel, ws_80_thresh_h1)

ws_80_h3_90, ws_80_h3_max, ws_80_h3_9km, ws_80_h3_27km, ws_80_h3_42km = calc_ens_products(ws_80, radius_max_9km, radius_max_27km, radius_max_42km, kernel, ws_80_thresh_h3)
...
rain_three_prob_42 = fout.createVariable('rain_three_prob_42km', 'f4', ('NY','NX',))
rain_three_prob_42.long_name = "Accumulated ensemble probability of rainfall greater than 3 inches (42 km neighborhood)"
rain_three_prob_42.units = "%"

rain_six_prob_3 = fout.createVariable('rain_six_prob_3km', 'f4', ('NY','NX',))
rain_six_prob_3.long_name = "Accumulated ensemble gridpoint probability of rainfall greater than 6 inches"
rain_six_prob_3.units = "%"

rain_six_prob_27 = fout.createVariable('rain_six_prob_27km', 'f4', ('NY','NX',))
rain_six_prob_27.long_name = "Accumulated ensemble probability of rainfall greater than 6 inches (27 km neighborhood)"
rain_six_prob_27.units = "%"

rain_six_prob_42 = fout.createVariable('rain_six_prob_42km', 'f4', ('NY','NX',))
rain_six_prob_42.long_name = "Accumulated ensemble probability of rainfall greater than 6 inches (42 km neighborhood)"
rain_six_prob_42.units = "%"
...
ws_80_prob_42_ts = fout.createVariable('ws_80_prob_42km_ts', 'f4', ('NY','NX',))
ws_80_prob_42_ts.long_name = "Accumulated ensemble probability of 80-m wind speed greater than 34 kts (42 km neighborhod)"
ws_80_prob_42_ts.units = "%"
...
ws_80_prob_42_h1 = fout.createVariable('ws_80_prob_42km_h1', 'f4', ('NY','NX',))
ws_80_prob_42_h1.long_name = "Accumulated ensemble probability of 80-m wind speed greater than 64 kts (42 km neighborhod)"
ws_80_prob_42_h1.units = "%"
...
ws_80_prob_42_h3 = fout.createVariable('ws_80_prob_42km_h3', 'f4', ('NY','NX',))
ws_80_prob_42_h3.long_name = "Accumulated ensemble probability of 80-m wind speed greater than 94 kts (42 km neighborhod)"
ws_80_prob_42_h3.units = "%"
...
fout.variables['rain_three_prob_42km'][:] = rain_three_42km

fout.variables['rain_six_prob_3km'][:] = rain_six_3km
fout.variables['rain_six_prob_27km'][:] = rain_six_27km
fout.variables['rain_six_prob_42km'][:] = rain_six_42km
