...
for f, file in enumerate(summary_files_temp):
   if ((file[-28:-25] == 'SMR') and (file[-24:-22] == timestep)):                               #assumes filename format of: news-e_ENS_20170516_2200_0000.nc
      infile = os.path.join(summary_dir, file)

print 'Matched SMR File: ', timestep, '   ', infile
...
rain_levels		= [0.01, 0.1, 0.25, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 4.0, 5.0, 7.0, 10.0]
