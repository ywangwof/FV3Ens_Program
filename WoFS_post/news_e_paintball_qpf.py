...
rain_obj_1 = find_objects_timestep(rain_mem, radmask, qpf_thresh_1, 0)
rain_obj_2 = find_objects_timestep(rain_mem, radmask, qpf_thresh_2, 0)
rain_obj_3 = find_objects_timestep(rain_mem, radmask, qpf_thresh_3, 0)
...
### Plot dz objects:
print( 't is:  ', t )
paintqc_plot(map, fig, ax1, ax2, ax3, x, y, x, y, qpf_paint_plot_1, aws_qc, rain_obj_1, radmask, t, init_label, valid_label, domain, outdir, 5, 0, blank='False')
...
paintqc_plot(map2, fig2, ax21, ax22, ax23, x, y, x, y, qpf_paint_plot_2, aws_qc, rain_obj_2, radmask, t, init_label, valid_label, domain, outdir, 5, 0, blank='False')
...
paintqc_plot(map3, fig3, ax31, ax32, ax33, x, y, x, y, qpf_paint_plot_3, aws_qc, rain_obj_3, radmask, t, init_label, valid_label, domain, outdir, 5, 0, blank='False')
