...
#   if ((swt_found == 1) and ((swt_t % 12) == 0) and (swt_t < fcst_nt)):
      if (((swt_t % int1hr) == 0) and (swt_t < fcst_nt)):
         start_t = swt_t
         time.sleep(2)
...
uh_2to5_90_hourly, uh_2to5_max_hourly, uh_2to5_9km_hourly, uh_2to5_15km_hourly, uh_2to5_27km_hourly = calc_ens_products(uh_2to5_hourly, radius_max_9km, radius_max_15km, radius_max_27km, kernel, uh_2to5_thresh)
...
uh_0to2_90_hourly, uh_0to2_max_hourly, uh_0to2_9km_hourly, uh_0to2_15km_hourly, uh_0to2_27km_hourly = calc_ens_products(uh_0to2_hourly, radius_max_9km, radius_max_15km, radius_max_27km, kernel, uh_0to2_thresh)
...
wz_0to2_90_hourly, wz_0to2_max_hourly, wz_0to2_9km_hourly, wz_0to2_15km_hourly, wz_0to2_27km_hourly = calc_ens_products(wz_0to2_hourly, radius_max_9km, radius_max_15km, radius_max_27km, kernel, wz_0to2_thresh)
...
#rain_half_90_hourly, rain_half_max_hourly, rain_half_3km_hourly, rain_half_15km_hourly, rain_half_27km_hourly = calc_ens_products(rain_hourly, 1, radius_max_15km, radius_max_27km, kernel, rain_1_thresh)
...
#rain_one_90_hourly, rain_one_max_hourly, rain_one_3km_hourly, rain_one_15km_hourly, rain_one_27km_hourly = calc_ens_products(rain_hourly, 1, radius_max_15km, radius_max_27km, kernel, rain_2_thresh)
...
#rain_two_90_hourly, rain_two_max_hourly, rain_two_3km_hourly, rain_two_15km_hourly, rain_two_27km_hourly = calc_ens_products(rain_hourly, 1, radius_max_15km, radius_max_27km, kernel, rain_3_thresh)
...
w_up_90_hourly, w_up_max_hourly, w_up_9km_hourly, w_up_15km_hourly, w_up_27km_hourly = calc_ens_products(w_up_hourly, radius_max_9km, radius_max_15km, radius_max_27km, kernel, w_up_thresh)
...
#ws_80_90_hourly, ws_80_max_hourly, ws_80_9km_hourly, ws_80_15km_hourly, ws_80_27km_hourly = calc_ens_products(ws_80_hourly, radius_max_9km, radius_max_15km, radius_max_27km, kernel, ws_80_thresh)
...
hail_90_hourly, hail_max_hourly, hail_9km_hourly, hail_15km_hourly, hail_27km_hourly = calc_ens_products(hail_hourly, radius_max_9km, radius_max_15km, radius_max_27km, kernel, hail_thresh)
...
hailcast_90_hourly, hailcast_max_hourly, hailcast_9km_hourly, hailcast_15km_hourly, hailcast_27km_hourly = calc_ens_products(hailcast_hourly, radius_max_9km, radius_max_15km, radius_max_27km, kernel, hail_thresh)
...
uh_2to5_prob_15_hourly = fout.createVariable('uh_2to5_prob_15km_hourly', 'f4', ('NY','NX',))
uh_2to5_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of 2-5 km updraft helicity greater than 60 m^2/S^2 (15 km neighborhod)"
uh_2to5_prob_15_hourly.units = "%"
...
uh_0to2_prob_15_hourly = fout.createVariable('uh_0to2_prob_15km_hourly', 'f4', ('NY','NX',))
uh_0to2_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of 0-2 km updraft helicity greater than 30 m^2/S^2 (15 km neighborhod)"
uh_0to2_prob_15_hourly.units = "%"
...
wz_0to2_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of 0-2 km average vertical vorticity greater than 0.003 s^-1 (15 km neighborhod)"
...
#rain_half_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of rainfall greater than 0.5 inches (15 km neighborhood)"
...
#rain_one_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of rainfall greater than 1 inch (15 km neighborhood)"
...
#ws_80_prob_9_hourly.long_name = "1-hr Accumulated ensemble probability of 80-m wind speed greater than 50 kts (9 km neighborhod)"
...
#ws_80_prob_15.units = "%"
#
#ws_80_prob_15_hourly = fout.createVariable('ws_80_prob_15km_hourly', 'f4', ('NY','NX',))
#ws_80_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of 80-m wind speed greater than 50 kts (15 km neighborhod)"
#ws_80_prob_15_hourly.units = "%"
#
...
#ws_80_prob_27_hourly.long_name = "1-hr Accumulated ensemble probability of 80-m wind speed greater than 50 kts (27 km neighborhod)"
...
w_up_prob_15_hourly = fout.createVariable('w_up_prob_15km_hourly', 'f4', ('NY','NX',))
w_up_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of updraft velocity greater than 10 m/s (15 km neighborhod)"
w_up_prob_15_hourly.units = "%"
...
hail_prob_15_hourly = fout.createVariable('hail_prob_15km_hourly', 'f4', ('NY','NX',))
hail_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of maximum hail size at the surface (NSSL 2-Moment) greater than 1 in (15 km neighborhod)"
hail_prob_15_hourly.units = "%"
...
hailcast_prob_15_hourly = fout.createVariable('hailcast_prob_15km_hourly', 'f4', ('NY','NX',))
hailcast_prob_15_hourly.long_name = "1-hr Accumulated ensemble probability of maximum hail size at the surface (Hailcast) greater than 1 in (15 km neighborhod)"
hailcast_prob_15_hourly.units = "%"
...
#   fout.variables['rain_out'][:] = rain_out
   ...
   fout.variables['hailcast_out'][:] = hailcast_out
...
fout.variables['uh_2to5_prob_15km_hourly'][:] = uh_2to5_15km_hourly
...
fout.variables['uh_0to2_prob_15km_hourly'][:] = uh_0to2_15km_hourly
...
fout.variables['w_up_prob_15km_hourly'][:] = w_up_15km_hourly
...
#fout.variables['ws_80_prob_15km_hourly'][:] = ws_80_15km_hourly
...
fout.variables['hail_prob_15km_hourly'][:] = hail_15km_hourly
...
fout.variables['hailcast_prob_15km_hourly'][:] = hailcast_15km_hourly
