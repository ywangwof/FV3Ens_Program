...
if (name == 'wz_0to2'): 
   ...
   if ((t > 0) and ((t % 12) == 0)):
      ...
      var_15km = fin.variables["wz_0to2_prob_15km_hourly"][edge:-edge,edge:-edge]
...
if (name == 'uh_0to2'):
   ...
   if ((t > 0) and ((t % 12) == 0)):
      ...
      var_15km = fin.variables["uh_0to2_prob_15km_hourly"][edge:-edge,edge:-edge]
...
if (name == 'uh_2to5'):
   ...
   if ((t > 0) and ((t % 12) == 0)):
      ...
      var_15km = fin.variables["uh_2to5_prob_15km_hourly"][edge:-edge,edge:-edge]
...
if (name == 'comp_dz'):
   ...
   if ((t > 0) and ((t % 12) == 0)):
      ...
      var_15km = fin.variables["comp_dz_prob_15km_hourly"][edge:-edge,edge:-edge]
...
if (name == 'w_up'):
   ...
   if ((t > 0) and ((t % 12) == 0)):
      ...
      var_15km = fin.variables["w_up_prob_15km_hourly"][edge:-edge,edge:-edge]
...
if (name == 'ws_80'):
   ...
   if ((t > 0) and ((t % 12) == 0)):
      ...
      var_15km = fin.variables["ws_80_prob_15km_hourly"][edge:-edge,edge:-edge]
...
if (name == 'hail'):
   ...
   if ((t > 0) and ((t % 12) == 0)):
      ...
      var_15km = fin.variables["hail_prob_15km_hourly"][edge:-edge,edge:-edge]
...
if (name == 'hailcast'):
   ...
   if ((t > 0) and ((t % 12) == 0)):
      ...
      var_15km = fin.variables["hailcast_prob_15km_hourly"][edge:-edge,edge:-edge]
