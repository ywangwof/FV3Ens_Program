...
##################### Get dimensions and attributes using first WRFOUT file ########################
      ...
      xlat = fin.variables["xlat"][edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]                     #latitude (dec deg; Lambert conformal)
      xlon = fin.variables["xlon"][edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]                    #longitude (dec deg; Lambert conformal)
      hgt = fin.variables["hgt"][edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]                       #terrain height above MSL (m)

      nz = fin.dimensions['NZ'].size
      ny, nx = xlat.shape
...
############################### Read WRFOUT variables: ##################################
   ...
   ph = fin.variables["ph"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]
   phb = fin.variables["phb"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]
   pr = fin.variables["p"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]
   pb = fin.variables["pb"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]

   u[f,:,:,:] = fin.variables["w"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]                          #convert staggered grids to centered
   v[f,:,:,:] = fin.variables["v"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]
   w = fin.variables["w"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]

   qv = fin.variables["qvapor"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]

   q[f,:,:,:] = np.where(qv < 0., 0.0001, qv)  #force qv to be positive definite

   th = fin.variables["t"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]
   th = th + 300.    	#add base state temp (300 K) to potential temp

   dz = fin.variables["delz"][:,edge+edge+2:-edge-edge:14,edge+edge+2:-edge-edge:14]
