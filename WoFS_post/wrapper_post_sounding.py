...
#         print 'current_t ', current_t, 'len(member_files) ', len(member_files)
   ...
   if (process == 1): 
      if (current_t >= 3): 
         cmd = "/home/kimberly.hoogewind/miniconda3/envs/py3/bin/python wofs_sounding_variable_extractor.py -d %s -o %s -t %d " % (fcst_dir, outdir, (current_t-3))
...
cmd = "/home/kimberly.hoogewind/miniconda3/envs/py3/bin/python wofs_sounding_variable_extractor.py -d %s -o %s -t %d " % (fcst_dir, outdir, (current_t-2))
pool.apply_async(run_script, (cmd,))

time.sleep(10)

cmd = "/home/kimberly.hoogewind/miniconda3/envs/py3/bin/python wofs_sounding_variable_extractor.py -d %s -o %s -t %d " % (fcst_dir, outdir, (current_t-1))
pool.apply_async(run_script, (cmd,))

time.sleep(10)

cmd = "/home/kimberly.hoogewind/miniconda3/envs/py3/bin/python wofs_sounding_variable_extractor.py -d %s -o %s -t %d " % (fcst_dir, outdir, current_t)
pool.apply_async(run_script, (cmd,))
