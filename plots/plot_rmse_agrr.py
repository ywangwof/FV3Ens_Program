...
def plot_all(var_stds,var_rmse,var_bias,times,varens,initdate, cases):
    ...
    #plt.show()
    figname = f"stat2m_{initdate}.png"
    print(f"Saving figure to {figname} ...")
    fig.savefig(figname, format='png')
...
def plot_indiv(varname,var_in,times,varens,initdate, cases):
    ...
    #plt.show()
    figname = f"stat2m_{varname}_{initdate}.png"
    print(f"Saving figure to {figname} ...")
    fig.savefig(figname, format='png')
...
if __name__ == "__main__":
    ...
    #
    plot_all(var_stds,var_rmse,var_bias,range(fmin//60+1),varens[fileindx],'norm_aggreg',casenames)

    #
    # plot rmse, std, bias in its own figure individually
    #
    plot_indiv('rmse',var_rmse,range(fmin//60+1),varens[fileindx],'norm_aggreg',casenames)
    plot_indiv('std_',var_stds,range(fmin//60+1),varens[fileindx],'norm_aggreg',casenames)
    plot_indiv('bias',var_bias,range(fmin//60+1),varens[fileindx],'norm_aggreg',casenames)
