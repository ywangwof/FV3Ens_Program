...
export OMP_NUM_THREADS_CH=${OMP_NUM_THREADS_CH:-48}
...
export FIXfv3=${FIXfv3:-$HOMEgfs/grid_orog}
export FIXam=${FIXam:-$HOMEgfs/fix_am}
...
export GRID_OROG_INPUT_DIR=${GRID_OROG_INPUT_DIR:-$FIXfv3}
